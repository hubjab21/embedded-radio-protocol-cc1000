...
#define TEST_PIN_DEFAULT_CONFIG					GPIO_MODE_OUTPUT | GPIO_MODE_SPEED_2MHZ

#define TEST_PORT_PORT							GPIOC
#define TEST_PORT_PORT_MASK						((1 << 6) | (1 << 7))
#define TEST_PORT_DEFAULT_CONFIG				GPIO_MODE_OUTPUT | GPIO_MODE_PULL_UP
// -----------------------------------------------------------------------------
