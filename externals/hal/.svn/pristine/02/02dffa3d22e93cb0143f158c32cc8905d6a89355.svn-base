...
// frequency of external 32k clock
#define STM32_EXT32_FREQ						0
...
#define TEST_PIN_DEFAULT_CONFIG					GPIO_MODE_AF | GPIO_MODE_AF_MCO | GPIO_MODE_SPEED_100MHZ

#define TEST2_PIN_PORT							GPIOC
#define TEST2_PIN_PIN							9
#define TEST2_PIN_DEFAULT_CONFIG				GPIO_MODE_AF | GPIO_MODE_AF_MCO | GPIO_MODE_SPEED_100MHZ
...
#define HALPORT_USART1_RXBUF_SIZE               2048
#define HALPORT_USART1_TXBUF_SIZE               2048
...
#define HALPORT_USART2_DEFAULT_BAUDRATE         38400
...
#define HALPORT_USART3_ENABLE_EVENT_MODE        0
#define HALPORT_USART3_ENABLE_DMA_MODE          0
...
#define HALPORT_UART4_DEFAULT_BAUDRATE          38400
#define HALPORT_UART4_ENABLE_POLLING_MODE       1
#define HALPORT_UART4_ENABLE_BUFFERED_MODE      0
#define HALPORT_UART4_ENABLE_EVENT_MODE         0
#define HALPORT_UART4_ENABLE_DMA_MODE           0
...
#define HALPORT_UART5_ENABLE_EVENT_MODE         0
#define HALPORT_UART5_ENABLE_DMA_MODE           0
