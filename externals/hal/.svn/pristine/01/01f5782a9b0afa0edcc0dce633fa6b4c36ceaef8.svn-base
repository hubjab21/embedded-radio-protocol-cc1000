...
--------------------------------------------------------------------------------
 File: 			hal_tim.h
 Author:        Piotr Wojtowicz, Lukasz Krzak
 Purpose:       HALFRED
 Compiler:      %COMPILER%
 Hardware:      independent
 Doc:           doxygen
--------------------------------------------------------------------------------
 Content:       HAL TIM module API
--------------------------------------------------------------------------------
 Comments:
================================================================================
*/
 ...
 *  \param tim timer handle
 *  \param since reference time
 *  \return time in nanoseconds
 */
uint64_t TIM_GetTimeElapsed(TIMDevice tim, TIM_Time since);

/**
 *  Converts ns time to timer time.
 *  \param tim timer handle
 *  \param ns time in nanoseconds
 *  \return time in timer format
 */
