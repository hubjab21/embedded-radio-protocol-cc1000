...
#define CS_PIN_PIN								1
#define CS_PIN_DEFAULT_CONFIG					GPIO_MODE_OUTPUT | GPIO_MODE_PULL_UP | GPIO_MODE_SPEED_50MHZ
#define CS_PIN_DISABLE_CONFIG					GPIO_MODE_INPUT

#define SPIS1_CUSTOM_PINS						1
#define SPIS1_SCLK_PORT							GPIOA
#define SPIS1_SCLK_PIN							5
#define SPIS1_SCLK_DEFAULT_CONFIG				GPIO_MODE_OUTPUT | GPIO_MODE_SPEED_2MHZ
#define SPIS1_SCLK_DISABLE_CONFIG				GPIO_MODE_INPUT

#define SPIS1_MISO_PORT							GPIOA
#define SPIS1_MISO_PIN							6
#define SPIS1_MISO_DEFAULT_CONFIG				GPIO_MODE_INPUT  | GPIO_MODE_SPEED_2MHZ
#define SPIS1_MISO_DISABLE_CONFIG				GPIO_MODE_INPUT

#define SPIS1_MOSI_PORT							GPIOA
#define SPIS1_MOSI_PIN							7
#define SPIS1_MOSI_DEFAULT_CONFIG				GPIO_MODE_OUTPUT | GPIO_MODE_SPEED_2MHZ
...
#define HALPORT_USART1_RXBUF_SIZE               512
#define HALPORT_USART1_TXBUF_SIZE               512
...
#define HALPORT_SPI2_MODE                       HALPORT_SPI_MODE_BUFFERED
...
#define HALPORT_SPI2_MSB_FIRST                  1
...
#define HALPORT_SPIS1_CLK_POLARITY              HALPORT_SPI_POLARITY_HIGH
#define HALPORT_SPIS1_CLK_PHASE                 HALPORT_SPI_PHASE_1EDGE
#define HALPORT_SPIS1_MSB_FIRST                 1
#define HALPORT_SPIS1_RXBUF_SIZE				128
// -----------------------------------------------------------------------------
