...
--------------------------------------------------------------------------------
 ...
 Doc:           doxygen
--------------------------------------------------------------------------------
 Content:       Declarations of the types used internally by the NV memory API.
--------------------------------------------------------------------------------
 Comments:		Putting this declarations in a separate file allows to perform
                deep unit testing.
================================================================================
*/
...
/*! \file hal_nv_internal.h
    \brief HAL non-volatile memory module - internal definitions
