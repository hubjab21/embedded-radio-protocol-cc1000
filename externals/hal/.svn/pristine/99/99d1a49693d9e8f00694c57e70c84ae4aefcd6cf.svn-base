...
#define TEST_PIN_PORT							0
#define TEST_PIN_PIN							1
#define TEST_PIN_DEFAULT_CONFIG					CONFIG_OUT

#define TEST_PIN2_PORT							0
#define TEST_PIN2_PIN							2
#define TEST_PIN2_DEFAULT_CONFIG				CONFIG_OUT
