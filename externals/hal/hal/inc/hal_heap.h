...
--------------------------------------------------------------------------------
 ...
 Doc:           doxygen
--------------------------------------------------------------------------------
 Content:       HAL heap memory manager
--------------------------------------------------------------------------------
 Comments:
================================================================================
*/
 ...
 * It was introduced in HALFRED to fight the chaos of heap management.
 *
 * <b>Background.</b>
 *
 ...
 *
 * To make HALFRED-based applications less vulnerable to heap problems, a dedicated heap engine
 * has been introduced.
 *
 * <b>Heap engine.</b>
 *
 ...
 * <i>MODE 0:</i>
 *
 * This is the default mode, the most passive and "uninvasive". In this mode HALFRED's internal
 ...
 * <i>MODE 1:</i>
 *
 * In this mode the heap will be serviced by a simple HALFRED's internal heap manager. This also means, that
 * whenever possible, OS heap will also be serviced by this HALFRED's internal heap manager.
 ...
 * This is the most recommended mode for HALFRED-based applications.
 *
 * <i>MODE 2:</i>
 *
 * In this mode the heap will be serviced by more advanced HALFRED's internal heap manager. This also means, that
 * whenever possible, OS heap will also be serviced by this HALFRED's internal heap manager.
...
// In this mode the heap is serviced by simple internal HALFRED memory manager
