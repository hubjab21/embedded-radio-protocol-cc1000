...
#define INPUT_PIN_PORT							GPIOE
#define INPUT_PIN_PIN							2
#define INPUT_PIN_DEFAULT_CONFIG_PULL_UP		GPIO_MODE_INPUT_PULL_UP_FILTER
#define INPUT_PIN_DEFAULT_CONFIG_PULL_DOWN		GPIO_MODE_INPUT_PULL_DOWN_FILTER
...
#define TEST_PORT_PORT							GPIOD
#define TEST_PORT_PORT_MASK						((1 << 7) | (1 << 8))
#define TEST_PORT_DEFAULT_CONFIG				GPIO_MODE_PUSH_PULL
// -----------------------------------------------------------------------------
...
#define TEST_TIM                                HAL_TIM0

#define HALPORT_USE_TIM0						1
#define HALPORT_TIM0_MAX_INTERRUPT_EVENTS       4
#define HALPORT_TIM0_MAX_TASK_EVENTS            4
